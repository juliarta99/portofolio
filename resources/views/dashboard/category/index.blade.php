...
@section('content')
      <div class="pt-20 pb-4 px-9">
            <div class="w-full xl:pl-64 lg:pl-52">
                  <a href="/dashboard/category/create" class="flex justify-center w-1/3 px-3 py-2 mb-3 font-semibold bg-blue-500 rounded-md lg:w-1/4 xl:w-1/6 text-hitam">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                              <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <h3 class="ml-2">Category Baru</h3>
                  </a>
                  @if (session()->has('succes'))
                  <div class="flex w-1/2 p-4 mb-5 bg-green-400 rounded-md lg:w-1/4">
                        <p>{{ session('succes') }}</p>
                        <button>
                              <a href="/dashboard/category/deleteSession">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
